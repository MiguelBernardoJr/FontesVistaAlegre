                    ...
                    */ 
                    ...
                    if !TMPZ06->(Eof())
                        ...
                        /* MB : 23.02.2023  
                            ...
                            If Z0G->Z0G_ZERTRT == "S" .and. TMPZ06->Z06_TRATO == "1"
                                nQtdTrato := 0
                                --nQtdAux
                            Else
                                ...
                                Else // If (nTrtTotal / nQtdAux) < MIN_TRATO
                                    ...
                                    If nDif == 0 // (nQtdAux+1) >= TMPZ06->QTD
                                        While (nQtdTrato := (nTrtTotal / nQtdAux)) < MIN_TRATO
                                            --nQtdAux
                                        EndDo
                                    ...
                                    EndIf
                                    If nQtdTrato > 0
                                        nQtdTrato := (TMPZ05->Z05_KGMSDI +  ((TMPZ05->Z05_KGMSDI * Z0G->Z0G_PERAJU ) / 100)) / (TMPZ06->QTD-nDif)
                                    EndIf
                                EndIf
                ...
                if !TMPZ05->(Eof())
                    ...
                    DbUseArea(.T., "TOPCONN", TCGenQry(,,;
                                            _cQry := " with QTDTRAT as (" + CRLF +;
                                                " select Z06.Z06_FILIAL, Z06.Z06_DATA, Z06.Z06_VERSAO, Z06.Z06_LOTE, count(*) QTD, Z0I.Z0I_NOTMAN, Z0G.Z0G_ZERTRT" + CRLF +;
                                             ...
                                             " group by Z06.Z06_FILIAL, Z06.Z06_DATA, Z06.Z06_VERSAO, Z06.Z06_LOTE, Z0I.Z0I_NOTMAN, Z0G.Z0G_ZERTRT" + CRLF +;
                                              " )" + CRLF +;
                                               " select Z06.*, QTDTRAT.QTD, QTDTRAT.Z0I_NOTMAN, QTDTRAT.Z0G_ZERTRT " + CRLF +;
                                                 " from " + RetSqlName("Z06") + " Z06" + CRLF +;
                                                 " join QTDTRAT" + CRLF +;
