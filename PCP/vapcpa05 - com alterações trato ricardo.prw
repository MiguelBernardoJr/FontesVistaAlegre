    ...
    if Empty(LOTES->Z0O_CODPLA)
        ...
        if !Empty(aChave := MaxVerTrat(LOTES->B8_LOTECTL, Z0R->Z0R_DATA))
            ...
            if !TMPZ05->(Eof())
                ...
                26/01/2023
                Arthur Toshio
                - Realizar a cópia individual de acordo com a Z06 - TRATO A TRATO ou fazer o calculo e a distribuição do ajuste do trato sem considerar Z06_TRATO do dia anterior
                */
