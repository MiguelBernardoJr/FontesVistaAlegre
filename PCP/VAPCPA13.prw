					...
					For nCntTrt := 1 To nNrTrt
						...
						While (!QRYREC->(EOF()))
							...
							For nCntBat := 1 To Len(aCsvAux)
								...
								cCsvEBt += AllTrim(Transform(aCsvAux[nCntBat][2], iIf(aCsvAux[nCntBat][3]=='P'.OR.aCsvAux[nCntBat][3]=='I'.or.nDivisa < 1,"@E 999,999,999.99", "@E 999999999"))) + ";"
