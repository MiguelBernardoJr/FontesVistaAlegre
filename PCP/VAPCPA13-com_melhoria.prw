...
// 								EndIf
								...
								RecLock("Z0Y", .T.)
									...
									if cTipo_carreg == 'B'
										...
										cOperador := Posicione("Z0X",2,xFilial("Z0X")+Z0X->Z0X_CODIGO,"Z0X_OPERAD")
...
*/
							/* Igor Oliveira 08.2022 */
								...
								/* Igor Oliveira 08.2022 */
									...
									_cQry += "	   , Z0Y_DOPER1 = " + StrTran(aDados[nI, nPKGDesvio],",",".") + " " + _ENTER_
									_cQry += "	   , Z0Y_DOPER2 = " + StrTran(aDados[nI, nPKGDesvio],",",".") + " " + _ENTER_
								
							/* 		_cQry += "	   , Z0Y_DOPER1 = " + StrTran(cValToChar(nDifOpe),",",".") + " " + _ENTER_
									_cQry += "	   , Z0Y_DOPER2 = " + StrTran(cValToChar(nDifOpe),",",".") + " " + _ENTER_ */
								
								
								//_cQry += "	   , Z0Y_DOPER1 = '" + nDifOpe + "' " + _ENTER_
								//_cQry += "	   , Z0Y_DOPER2 = '" + nDifOpe + "' " + _ENTER_
