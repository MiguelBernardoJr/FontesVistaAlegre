...
Static Function fQuadro1(cPerg)
	...
	_cQry += "		SELECT  SP8.P8_FILIAL, QB_DESCRIC, RA1.RA_NOME NOME_GESTOR, SRA.RA_CC, CTT_DESC01, SRA.RA_MAT, SRA.RA_NOME, RJ_DESC,  P8_DATA,SRA.RA_VALORDI, COUNT(P8_DATA) REGISTROS     " + CRLF 
	...
	_cQry += "		GROUP BY SP8.P8_FILIAL, QB_DESCRIC, RA1.RA_NOME, SRA.RA_CC, CTT_DESC01, SRA.RA_MAT, SRA.RA_NOME, SRA.RA_CARGO, RJ_DESC, SRA.RA_VALORDI,P8_DATA " + CRLF
	_cQry += ")   " + CRLF
	_cQry += "SELECT DISTINCT QB_DESCRIC, NOME_GESTOR, RA_CC, CTT_DESC01, P8_FILIAL, RA_MAT, RA_NOME, RJ_DESC, RA_VALORDI,  COUNT(P8_DATA) QT_DIAS, COUNT(P8_DATA)*RA_VALORDI AS VALOR   " + CRLF
	_cQry += "FROM  PONTO   " + CRLF
	_cQry += "GROUP BY P8_FILIAL, QB_DESCRIC, NOME_GESTOR, RA_CC, CTT_DESC01, RA_MAT, RA_NOME, RJ_DESC,RA_VALORDI     " + CRLF
